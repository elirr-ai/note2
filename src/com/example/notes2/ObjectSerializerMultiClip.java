...
public class ObjectSerializerMultiClip {

//    private static final Log log = LogFactory.getLog(ObjectSerializer.class);
    
    public static String serialize(List<ClipBoardHolder> myClipHolder2) throws IOException {
        if (myClipHolder2 == null) return "";
        try {
            ByteArrayOutputStream serialObj = new ByteArrayOutputStream();
            ObjectOutputStream objStream = new ObjectOutputStream(serialObj);
            objStream.writeObject(myClipHolder2);
            objStream.close();
