...
public class DirectoryFilesHolder {
	private int dir_image;
	...
	public DirectoryFilesHolder(int dir_image,int total_files,int image_files,
			String dir_name,String date_created , String fullFileName,
			int Index , String attrib , long curMillis,Bitmap bm ) {
		super();
	...
	public String getext() {
		...
		String a=fullFileName.substring(fullFileName.indexOf(".")+1).toLowerCase();
		String type = mime.getMimeTypeFromExtension(a);
		return type;
	}
